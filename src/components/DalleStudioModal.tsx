...
export const DalleStudioModal: React.FC<DalleStudioModalProps> = ({
  ...
  const [modelChoice, setModelChoice] = useState<'gemini' | 'dalle'>('gemini');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                NEXUS Visual Studio & Image Editor
              ...
              <p className="text-xs text-white/50">
                Hasilkan dan edit gambar berkualitas ultra-tinggi dengan prompt deskriptif
              </p>
            </div>
          </div>
          <button
